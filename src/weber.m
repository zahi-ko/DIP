...
ha = fspecial("average", window_width);

% Is = imfilter(I, ha, 'replicate'); fname = '均值滤波器';
...
% Igf = cat(3, imgaussfilt(I, s(1), "FilterSize", w(1)), ...
%     imgaussfilt(I, s(2), 'FilterSize', w(2)), ...
%     imgaussfilt(I, s(3), 'FilterSize', w(3)));
